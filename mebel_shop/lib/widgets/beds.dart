...
class Beds1 extends StatefulWidget {
  const Beds1(BuildContext context, {Key? key}) : super(key: key);

  @override
  State<Beds1> createState() => _Bathroom1State();
}

class _Bathroom1State extends State<Beds1> {
  List<Beds> items = [
    const Beds(
        baho: '5',
        title: 'Popular 1',
        image: 'assets/beds2.png',
        discription: 'Lorem ipsum dolor',
        price: '240.00'),
    const Beds(
        baho: '3',
        title: 'Popular 2',
        image: 'assets/beds3.png',
        discription: 'Lorem ipsum dolor',
        price: '590.00'),
    const Beds(
        baho: '4.6',
        title: 'Popular 3',
        image: 'assets/beds4.png',
        discription: 'Lorem ipsum dolor',
        price: '240.00'),
    const Beds(
        baho: '2.8',
        title: 'Popular 4',
        image: 'assets/beds5.png',
        discription: 'Lorem ipsum dolor',
        price: '590.00'),
  ];
