...
class Lighting1 extends StatefulWidget {
  const Lighting1(BuildContext context, {Key? key}) : super(key: key);

  @override
  State<Lighting1> createState() => _Bathroom1State();
}

class _Bathroom1State extends State<Lighting1> {
  List<Lighting> items = [
    const Lighting(
        baho: '5',
        title: 'Popular 1',
        image: 'assets/razetka.png',
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => Lighting2(item: itemlar)));
                      },
                      child: Column(
                        children: [
                          Row(
...
class Lighting2 extends StatefulWidget {
  final Lighting item;
  const Lighting2({Key? key, required this.item}) : super(key: key);

  @override
  State<Lighting2> createState() => _Lighting2State();
}
          ...
          children: [
            ...
            Center(
              child: CupertinoButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context, ScaleTransition5(BuyPage(context)));
                },
